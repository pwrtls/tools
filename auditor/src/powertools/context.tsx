...
type PowerToolsContextType = {
    ...
    changeConnection: (newConnectionName: string) => void;
};

export const PowerToolsContext = React.createContext<PowerToolsContextType>({
    isLoaded: false,
    connectionName: '',
    changeConnection: () => {} // Add a no-op function as default
});
...
export class PowerToolsContextProvider extends React.PureComponent<IPowerToolsContextProviderProps, IPowerToolsContextProviderState> {
    ...
    changeConnection = (newConnectionName: string) => {
        // This is a placeholder. In a real implementation, you'd need to
        // interact with the PowerTools API to change the connection.
        this.setState({ connectionName: newConnectionName });
    }
